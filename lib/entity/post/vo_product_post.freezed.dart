...
mixin _$ProductPost {
  ...
  User get user => throw _privateConstructorUsedError; //int userId로 작업하기도 함
...
class _$_ProductPost implements _ProductPost {
  const _$_ProductPost(this.id, this.user, this.product, this.content,
...
//int userId로 작업하기도 함
  ...
  @override
  String toString() {
    return 'ProductPost(id: $id, user: $user, product: $product, content: $content, address: $address, chatCount: $chatCount, likeCount: $likeCount, createdTime: $createdTime)';
  }
...
abstract class _ProductPost implements ProductPost {
  const factory _ProductPost(
      ...
      final int chatCount,
      final int likeCount,
      final DateTime createdTime) = _$_ProductPost;

  @override
  int get id;
  @override
  User get user;
  @override //int userId로 작업하기도 함
  Product get product;
  @override
  String get content;
  @override
