              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      product.price.toWon().text.size(15).make(),
                      "가격 제안하기".text.color(Colors.orange).underline.bold.make(),
                    ],
                  ),
                ),
                RoundButton(
                    text: "채팅하기",
                    bgColor: Vx.orange400,
                    borderRadius: 10.0,
                    onTap: () {})
              ],
            ).pSymmetric(h: 10),
        ...
        children: [
          PageView(
            ...
            children: simpleProductPost.product.images.map((url) =>
                //Boxfit.fill : 꽉 차는 이미지
                CachedNetworkImage(imageUrl: url, fit: BoxFit.fill)).toList(),
          ),
